...
set_global_assignment -name SYSTEMVERILOG_FILE credit_wrapper.sv
set_global_assignment -name SYSTEMVERILOG_FILE testbench.sv
set_global_assignment -name SYSTEMVERILOG_FILE scdpram_infer.sv
set_global_assignment -name SYSTEMVERILOG_FILE fifo_logic.sv
set_global_assignment -name SYSTEMVERILOG_FILE fifo.sv
set_global_assignment -name SYSTEMVERILOG_FILE credit_interconnect_regs.sv
set_global_assignment -name SYSTEMVERILOG_FILE credit_counter.sv
