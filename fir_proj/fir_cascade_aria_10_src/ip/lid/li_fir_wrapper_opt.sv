module li_fir_wrapper_opt #(
	...
	wire w_i_valid_i_in_link_buf_enq;
	...
	li_input_buffer #(
		...
		.i_enq      (w_i_valid_i_in_link_buf_enq),
	...
	always@(posedge clk or posedge reset) begin
		if(reset) begin
			...
			if(o_out_o_valid_link.stop && r_o_out_o_valid_link_done)
				r_o_out_o_valid_link_done <= 1'b1;
			else
	...
	//Enq
	assign w_i_valid_i_in_link_buf_enq = i_valid_i_in_link.valid && (!w_fire || !w_i_valid_i_in_link_buf_empty) && !w_i_valid_i_in_link_buf_full;
